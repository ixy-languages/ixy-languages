...
\begin{axis}[
	title={Latency when forwarding 10\,Mpps},
	width=12cm,
	height=8cm,
	x dir=reverse,
	xmode=log,
...
\addplot [mark=none,color=TUMBlack, thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {data/latency-10/c-cdf.csv}; \addlegendentry{C}
\addplot [mark=none,color=TUMDarkerBlue, thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {data/latency-10/rust-cdf.csv}; \addlegendentry{Rust}
\addplot [mark=none,color=TUMGreen, thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {data/latency-10/go-cdf.csv}; \addlegendentry{Go}
\addplot [mark=none,color=TUMOrange, thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {data/latency-10/csharp-cdf.csv}; \addlegendentry{C\#}
